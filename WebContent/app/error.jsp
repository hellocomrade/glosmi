...
String msg=null;
if(null!=session.getAttribute("APP_ERROR"))
{
	msg=session.getAttribute("APP_ERROR").toString().trim();
	session.setAttribute("APP_ERROR",null);
}
else
{
...
<%
if(literals!=null)
	out.println(String.format("%s%s",literals.getText("title"),literals.getText("/app/error.jsp")));
else
	out.println("Error");
%>
</title>
