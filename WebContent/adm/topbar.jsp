	...
	<div class="dock" id="<%=request.getParameter("id") %>">
		<div class="dock-container">
    		<a class="dock-item" href="../pub"><img src="../img/fisheye/home.png" alt="home" /><span>Home</span></a> 
  			<a class="dock-item" href="../adm/useradmin.jsp"><img src="../img/fisheye/users.png" alt="contact" /><span>Users</span></a> 
<%
...
<%
	...
	{
%>
  			<a class="dock-item" href="../app/"><img src="../img/fisheye/applications.png" alt="applcation" /><span>Applications</span></a> 
<%
	}
%>
  			<a class="dock-item" href="../adm/fileadmin.glos?islist=1"><img src="../img/fisheye/attachment_mgt.png" alt="files" /><span>Files</span></a> 
...
<div id="div_addon">
    <form id="frm_chgp" action="../adm/useradmin.glos">
		<jsp:include page="../WEB-INF/controls/user-password.jsp" flush="true"/>
	</form>
	<form id="frm_update" action="../adm/useradmin.glos">
