...
%>
  			...
  			-->
  			<a class="dock-item" href="../mod/fileadmin.glos?islist=1"><img src="../img/fisheye/attachment_mgt.png" alt="files" /><span>Files</span></a> 
...
<div id="div_addon">
    <form id="frm_chgp" action="../mod/useradmin.glos">
		<jsp:include page="../WEB-INF/controls/user-password.jsp" flush="true"/>
	</form>
	<form id="frm_update" action="../mod/useradmin.glos">
