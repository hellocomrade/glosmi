...
<%
if(literals!=null)
	out.println(String.format("%s%s",literals.getText("title"),literals.getText("modempty.jsp")));
else
	out.println("Empty Model List");
%>
</title>
...
<div style="margin-left:auto;margin-right:auto;width:500px;">
	<div class="tip">Your model inventory is empty.</div>
<%
...
%>
	<br/>
	<div align="center">
		<a href="modadmin.glos?mod_action=new">Add New Model</a>
		<strong>|</strong>
