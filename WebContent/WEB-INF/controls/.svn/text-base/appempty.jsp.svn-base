...
<%
if(literals!=null)
	out.println(String.format("%s%s",literals.getText("title"),literals.getText("appempty.jsp")));
else
	out.println("Empty Application List");
%>
</title>
...
<div style="margin-left:auto;margin-right:auto;width:500px;">
	<div class="tip1">Your application inventory is empty.</div>
<%
