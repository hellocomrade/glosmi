...
<%
if(literals!=null)
	out.println(String.format("%s%s",literals.getText("title"),literals.getText("draftmpty.jsp")));
else
	out.println("Empty Draft List");
%>
</title>
...
<div style="margin-left:auto;margin-right:auto;width:500px;">
	<div class="tip">Your Draft list is empty.</div>
</div>
<br/>
<div align="center">
