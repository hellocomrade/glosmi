...
<%
if(literals!=null)
	out.println(String.format("%s%s",literals.getText("title"),literals.getText("apppendingempty.jsp")));
else
	out.println("Empty Pending Application List");
%>
</title>
...
<div style="margin-left:auto;margin-right:auto;width:500px;">
	<div class="tip1">Your pending list is empty.</div>
<%
...
%>
	<br/>
	<div align="center">
		<a href="appadmin.glos?app_action=new">Add New Application</a>
		<strong>|</strong>
